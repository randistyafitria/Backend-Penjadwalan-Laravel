...
<h6 class="h2 text-white d-inline-block mb-0">TABEL JADWAL KULIAH</h6>
...
<tr>
<th scope="col" class="sort" data-sort="kode_pengampu">KODE PENGAMPU</th>
<th scope="col" class="sort" data-sort="kode_jam">KODE JAM</th>
<th scope="col" class="sort" data-sort="kode_hari">KODE HARI</th>
<th scope="col" class="sort" data-sort="kode_ruang">KODE RUANG</th>
<th scope="col">OPTION</th>
</tr>
</thead>
<tbody class="list">
@foreach($jadkuls as $jadkul)
<tr>
...
<td class="text-left">
<router-link :to="{name: 'jadkul.edit', params:{id: jadkul.id }}" class="btn btn-sm btn-primary mr-1">EDIT</router-link>
