...
<h6 class="h2 text-white d-inline-block mb-0">TABEL MATA KULIAH</h6>
...
<td class="text-left">
<router-link :to="{name: 'matkul.edit', params:{id: matkul.id }}" class="btn btn-sm btn-primary mr-1">EDIT</router-link>
...
<router-link :to="{name: 'matkul.create'}" class="btn btn-md btn-success">TAMBAH MATA KULIAH</router-link>
<nav aria-label="...">
