...
@foreach ($dosen->jadkul as $jadkuls)
@foreach ($dosen->pengampu as $pengampus)

<tr>
<td> {{ $loop->iteration }} </td>
<td> {{ $jadkuls->hari->nama }} </td>
<td> {{ $jadkuls->jam->id }} </td>
<td> {{ $jadkuls->jam->range_jam }} </td>
<td> {{ $pengampus->matkul->nama }} </td>
<td> {{ $pengampus->matkul->sks }} </td>
<td> {{ $pengampus->matkul->semester }} </td>
<td> {{ $jadkuls->pengampu->kelas }} </td>
<td> {{ $dosen->nama }} </td>
<td> {{ $jadkuls->ruang->nama }} </td>
