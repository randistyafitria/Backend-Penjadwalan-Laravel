...
<h6 class="h2 text-white d-inline-block mb-0">TABEL WAKTU TIDAK BERSEDIA</h6>
...
<h3 class="mb-0">Waktu Tidak Bersedia</h3>
</div>
...
<tr>
<th scope="col" class="sort" data-sort="kode_dosen">KODE DOSEN</th>
<th scope="col" class="sort" data-sort="kode_hari">KODE HARI</th>
<th scope="col" class="sort" data-sort="kode_jam">KODE JAM</th>
<th scope="col">OPTION</th>
</tr>
</thead>
<tbody class="list">
@foreach($wkt_tdk_bersedias as $wkt_tdk_bersedia)
<tr>
...
<td class="text-left">
<router-link :to="{name: 'wkt_tdk_bersedia.edit', params:{id: wkt_tdk_bersedia.id }}" class="btn btn-sm btn-primary mr-1">EDIT</router-link>
...
<router-link :to="{name: 'wkt_tdk_bersedia.create'}" class="btn btn-md btn-success">TAMBAH WAKTU TIDAK BERSEDIA</router-link>
<nav aria-label="...">
