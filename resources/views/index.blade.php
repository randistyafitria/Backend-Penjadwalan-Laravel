...
<h6 class="h2 text-white d-inline-block mb-0">TABEL PENJADWALAN</h6>
...
<th scope="col" class="sort" data-sort="sesi">SESI</th>
<th scope="col" class="sort" data-sort="range_jam">JAM KULIAH</th>
<th scope="col" class="sort" data-sort="matakuliah">MATAKULIAH</th>
...
<th scope="col" class="sort" data-sort="dosen">DOSEN</th>
<th scope="col" class="sort" data-sort="ruang">RUANG</th>
</tr>
</thead>
<tbody class="list">
    
@foreach ($dtPengampu as $pengampu)

<tr>
<td> {{ $loop->iteration }} </td>
<td> {{ $pengampu->matkul->nama }} </td>
...
<a href = "/jadwalkuliah/create" class="btn btn-md btn-success">TAMBAH JADWAL KULIAH</a>
<nav aria-label="...">
   ...
   <div class="content-form" align="center">
      ...
      <table class="table-common">
         ...
         <?php $no++ ;?>
               ...
               <td>{{ $no}}.</td>
               <td align="center">{{ $haris }}</td>
               <td align="center">{{ $jams }}</td>
               <td align="center">{{ $matkuls }}</td>
               <td align="center">{{ $matakul }}</td>
               <td align="center">{{ $mtkul }}</td>
               <td align="center">{{ $pengampus }}</td>
               <td align="center">{{ $dosens }}</td>
               <td align="center">{{ $ruangs }}</td>
