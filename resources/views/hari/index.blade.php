...
<h6 class="h2 text-white d-inline-block mb-0">TABEL HARI</h6>
...
<td class="text-left">
<router-link :to="{name: 'hari.edit', params:{id: hari.id }}" class="btn btn-sm btn-primary mr-1">EDIT</router-link>
