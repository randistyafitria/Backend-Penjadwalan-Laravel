...
<h6 class="h2 text-white d-inline-block mb-0">TABEL JAM</h6>
...
<tr>
<th scope="col" class="sort" data-sort="range_jam">RANGE JAM</th>
...
<td class="text-left">
<router-link :to="{name: 'jam.edit', params:{id: jam.id }}" class="btn btn-sm btn-primary mr-1">EDIT</router-link>
